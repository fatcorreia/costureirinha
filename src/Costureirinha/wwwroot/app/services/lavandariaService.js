...
var LavandariaService = (function () {
    function LavandariaService(_http, _configuration) {
        var _this = this;
        this._http = _http;
        ...
        this.actionUrl = _configuration.ServerWithApiUrl + 'lavandaria/';
        this.headers = new http_1.Headers();
        this.headers.append('Content-Type', 'application/json');
        this.headers.append('Accept', 'application/json');
    }
    return LavandariaService;
}());
LavandariaService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, app_constants_1.Configuration])
], LavandariaService);
exports.LavandariaService = LavandariaService;
//# sourceMappingURL=LavandariaService.js.map