...
var OpiniaoService = (function () {
    function OpiniaoService(_http, _configuration) {
        var _this = this;
        this._http = _http;
        ...
        this.AddAll = function (items) {
            ...
            return _this._http.post(_this.actionUrl, json, { headers: _this.headers });
        };
        ...
        this.actionUrl = _configuration.ServerWithApiUrl + 'opiniao/';
...
OpiniaoService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, app_constants_1.Configuration])
], OpiniaoService);
exports.OpiniaoService = OpiniaoService;
//# sourceMappingURL=OpiniaoService.js.map