...
var ArranjoService = (function () {
    function ArranjoService(_http, _configuration) {
        var _this = this;
        this._http = _http;
        ...
        this.actionUrl = _configuration.ServerWithApiUrl + 'arranjos/';
        this.headers = new http_1.Headers();
        this.headers.append('Content-Type', 'application/json');
        this.headers.append('Accept', 'application/json');
    }
    return ArranjoService;
}());
ArranjoService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, app_constants_1.Configuration])
], ArranjoService);
exports.ArranjoService = ArranjoService;
//# sourceMappingURL=ArranjoService.js.map